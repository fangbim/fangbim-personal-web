import { faGithub, faLinkedin, faBehance, faYoutube } from '@fortawesome/free-brands-svg-icons';
...
export default function SocialMedia() {
  ...
  return (
    <div className='mt-10 md:mt-20 w-full items-center justify-center flex'>
        <div className='flex flex-col md:flex-row gap-y-10 md:gap-44 items-center'>
            ...
            <a href='https://www.behance.net/fangbim'>
                <FontAwesomeIcon icon={faBehance} size='6x'/>
            </a>
